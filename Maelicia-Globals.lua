...
function define_global_sets()
	...
	gear.Vanya_hands_B = { name="Vanya Cuffs", augments={'Healing magic skill +20','"Cure" spellcasting time -7%','Magic dmg. taken -3',}}
	...
	gear.Herculean_body_WS = { name="Herculean Vest", augments={'Pet: STR+13','Pet: Crit.hit rate +3','Weapon skill damage +9%','Accuracy+18 Attack+18',}}
	...
	gear.Valorous_legs_WS = { name="Valorous Hose", augments={'Attack+15','Weapon skill damage +4%','DEX+7','Accuracy+10',}}
	...
	gear.Telchine_legs_pet = { name="Telchine Braconi", augments={'Mag. Evasion+23','Pet: "Regen"+3','Enh. Mag. eff. dur. +8',}}
...
function global_aliases()
	...
	send_command('alias divinetrust input /ma "' .. UnityConcord .. '" <me>;wait 5;input /ma "' .. Cor .. '" <me>;wait 5;input /ma "' ..  Alchemist .. '" <me>;wait 5;input /ma "' .. Bard2 .. '" <me>;wait 5;input /ma "' .. MeleeDD .. '" <me>;')
	send_command('alias tenzentrust input /ma "' .. UnityConcord .. '" <me>;wait 5;input /ma "' .. Cor .. '" <me>;wait 5;input /ma "' ..  Alchemist .. '" <me>;wait 5;input /ma "' .. Bard .. '" <me>;wait 5;input /ma "' .. RedMage .. '" <me>;')
