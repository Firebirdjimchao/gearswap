...
function init_gear_sets()
    ...
    -- Fast cast gear for specific spells or spell maps
        ...
        sets.precast.WS = {ammo="Aqreqaq Bomblet",
                                                                        head="Otomi Helm",neck="Portus Collar",ear1="Moonshade Earring",ear2="Brutal Earring",
                                                                        body="Mes. Haubergeon",hands="Pumm. Mufflers +1",ring1="Ifrit Ring +1",ring2="Ifrit Ring +1",
                                                                        back="Mauler's Mantle",waist="Windbuffet Belt +1",legs="Agoge Cuisses +1",feet="Pumm. Calligae +1"}
    ...
    -- Generic spell recast set
        ...
        -- Idle sets
        sets.idle = {ammo="Yetshila +1",
                                                head="Felistris Mask",neck="Twilight Torque",ear1="Tripudio Earring",ear2="Brutal Earring",
                        body={ name="Xaddi Mail", augments={'VIT+12','Phys. dmg. taken -5','Magic dmg. taken -3',}},hands="Agoge Mufflers +1",ring1="Dark Ring",ring2="Defending Ring",
                        back="Repulse Mantle",waist="Flume Belt",legs="Hachiryu Haidate",feet="Hermes' Sandals +1"}
 
        sets.idle.Town = {ammo="Yetshila +1",
                                                head="Gavialis Helm",neck="Twilight Torque",ear1="Tripudio Earring",ear2="Brutal Earring",
                        body="Goldsmith's Apron",hands="Cizin Mufflers +1",ring1="Ifrit Ring +1",ring2="Ifrit Ring +1",
                        back="Mauler's Mantle",waist="Flume Sash",legs="Hachiryu Haidate",feet="Hermes' Sandals +1"}
       
        sets.idle.Regen = {ammo="Angha Gem",
                                                head="Baghere Salade",neck="Wiglen Gorget",ear1="Tripudio Earring",ear2="Dawn Earring",
                        body="Kumarbi's Akar",hands="Agoge Mufflers +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
                        back="Repulse Mantle",waist="Lyopodium Sash",legs="Hachiryu Haidate",feet="Hermes' Sandals +1"}
    ...
    -- Gear to wear for kiting
        ...
        sets.engaged = {ammo="Yetshila +1",
                                                                        head="Felistris Mask",neck="Portus Collar",ear1="Trux Earring",ear2="Brutal Earring",
                                                                        body={ name="Xaddi Mail", augments={'Attack+15','Accuracy+10','"Store TP"+3',}},hands="Cizin Mufflers +1",ring1="K'ayres Ring",ring2="Rajas Ring",
                                                                        back="Mauler's Mantle",waist="Windbuffet Belt +1",legs="Agoge Cuisses +1",feet="Ejekamal Boots"}
        ...
        sets.engaged.PDT = set_combine(sets.engaged, {head="Ighwa Cap",neck="Twilight Torque"})
